...
Source fingerprint: 32cf5ec500762d39
...
- `function lockIdentityConfiguration() external onlyOwner whenIdentityConfigurable` ([contracts/AGIJobManager.sol#L757](../../contracts/AGIJobManager.sol#L757))
- `function applyForJob(uint256 _jobId, string memory subdomain, bytes32[] calldata proof)` ([contracts/AGIJobManager.sol#L789](../../contracts/AGIJobManager.sol#L789))
- `function validateJob(uint256 _jobId, string memory subdomain, bytes32[] calldata proof)` ([contracts/AGIJobManager.sol#L851](../../contracts/AGIJobManager.sol#L851))
- `function disapproveJob(uint256 _jobId, string memory subdomain, bytes32[] calldata proof)` ([contracts/AGIJobManager.sol#L859](../../contracts/AGIJobManager.sol#L859))
- `function updateAGITokenAddress(address _newTokenAddress) external onlyOwner whenIdentityConfigurable` ([contracts/AGIJobManager.sol#L1052](../../contracts/AGIJobManager.sol#L1052))
- `function updateEnsRegistry(address _newEnsRegistry) external onlyOwner whenIdentityConfigurable` ([contracts/AGIJobManager.sol#L1059](../../contracts/AGIJobManager.sol#L1059))
- `function updateNameWrapper(address _newNameWrapper) external onlyOwner whenIdentityConfigurable` ([contracts/AGIJobManager.sol#L1065](../../contracts/AGIJobManager.sol#L1065))
- `function setEnsJobPages(address _ensJobPages) external onlyOwner whenIdentityConfigurable` ([contracts/AGIJobManager.sol#L1071](../../contracts/AGIJobManager.sol#L1071))
- `function updateRootNodes(` ([contracts/AGIJobManager.sol#L1080](../../contracts/AGIJobManager.sol#L1080))
- `function updateMerkleRoots(bytes32 _validatorMerkleRoot, bytes32 _agentMerkleRoot)` ([contracts/AGIJobManager.sol#L1093](../../contracts/AGIJobManager.sol#L1093))
- `function lockJobENS(uint256 jobId, bool burnFuses) external` ([contracts/AGIJobManager.sol#L1325](../../contracts/AGIJobManager.sol#L1325))
- `function tokenURI(uint256 tokenId) public view override returns (string memory)` ([contracts/AGIJobManager.sol#L1574](../../contracts/AGIJobManager.sol#L1574))
- `function _callEnsJobPagesHook(uint8 hook, uint256 jobId) internal` ([contracts/AGIJobManager.sol#L1579](../../contracts/AGIJobManager.sol#L1579))
...
- @notice Anyone may lock ENS records after a job reaches a terminal state; only the owner may burn fuses. ([contracts/AGIJobManager.sol#L1323](../../contracts/AGIJobManager.sol#L1323))
- @dev Fuse burning is irreversible and remains owner-only; ENS hook execution is best-effort. ([contracts/AGIJobManager.sol#L1324](../../contracts/AGIJobManager.sol#L1324))
- @dev as long as lockedEscrow/locked*Bonds are fully covered. ([contracts/AGIJobManager.sol#L1371](../../contracts/AGIJobManager.sol#L1371))
- @dev Owner withdrawals are limited to balances not backing lockedEscrow/locked*Bonds. ([contracts/AGIJobManager.sol#L1609](../../contracts/AGIJobManager.sol#L1609))
