...
Source fingerprint: 900c491e8e8bf474
...
- `function tokenURI(uint256 tokenId) public view override returns (string memory)` ([contracts/AGIJobManager.sol#L1552](../../contracts/AGIJobManager.sol#L1552))
- `function _callEnsJobPagesHook(uint8 hook, uint256 jobId) internal` ([contracts/AGIJobManager.sol#L1557](../../contracts/AGIJobManager.sol#L1557))
...
- @dev Owner withdrawals are limited to balances not backing lockedEscrow/locked*Bonds. ([contracts/AGIJobManager.sol#L1587](../../contracts/AGIJobManager.sol#L1587))
