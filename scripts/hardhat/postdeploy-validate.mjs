...
for (const fn of ['quoteCreateJobBurn', 'getCreateJobFundingRequirement', 'getCreateJobFundingRequirementWithToken', 'getCreateJobAllowanceRequirement', 'getCreateJobAllowanceRequirementWithToken', 'getJobBurnAmountSnapshot', 'getJobEconomicSnapshot']) {
